...
function SliderUnlock(elm, options, success, always) {
    ...
    var opts = {
        ...
        max: typeof (options.max) !== 'undefined' || !isNaN(options.max) ? options.max : $$elm.clientWidth - $$(".slideunlock-btn")[0].clientWidth,
...
SliderUnlock.prototype.handerIn = function () {
    ...
    _self.min = 0;
    _self.max = _self.elm.clientWidth - $$(".slideunlock-btn")[0].clientWidth;
}
...
SliderUnlock.prototype.move = function () {
    var _self = this;
    if ((_self.index + 0)/75 >= (_self.max-192)/75) {
    ...
    if ((_self.index + 0)/75 == (_self.max-192)/75 && _self.max > 0 && _self.isOk) {
        _self.success();
    }
...
SliderUnlock.prototype.reset = function () {
    ...
    animateLeft($$(".slideunlock-btn")[0], _self.opts.duration, _self.index);
    animateOpacity($$(".slideunlock-txt")[0], _self.opts.duration, 1);
...
SliderUnlock.prototype.backgroundTranslate = function () {
    ...
    $$('.slideunlock-txt')[0].style.opacity = 1 - (parseInt($$(".slideunlock-btn")[0].style.left) / _self.max);
}
...
SliderUnlock.prototype.updateView = function () {
    var _self = this,
        _labelTipEle = $$(".slideunlock-txt")[0];
