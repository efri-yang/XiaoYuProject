...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		 ...
		 */
		/* add by yerz 20150519 */
		function removeac(){
			$('#section0,#section1,#section2,#section3,#section4').find('.wrap').addClass('animated fadeIn');
			$('#section0,#section1,#section2,#section3,#section4').find('.section-avatar').removeClass('animated fadeInDown');
			$('#section0,#section1,#section2,#section3,#section4').find('.section-tx').removeClass('animated fadeInUp');
			$('#section4').find('.section-img,.section-opt1,.section-opt2').removeClass('animated fadeInUp');
		}
		...
		function activateMenuElement(name){
			if(options.menu){
				...
				/* add by yerz 20150519 */
				var panel_num = $("#fullpage").find('.active').index();
				if(panel_num == 0){
					removeac();
					$('#section0').find('.wrap').addClass('animated fadeIn');
					$('#section0').find('.section-avatar').addClass('animated fadeInDown');
					$('#section0').find('.section-tx').addClass('animated fadeInUp');
				}
				if(panel_num == 1){
					removeac();
					$('#section1').find('.wrap').addClass('animated fadeIn');
					$('#section1').find('.section-avatar').addClass('animated fadeInDown');
					$('#section1').find('.section-tx').addClass('animated fadeInUp');
				}
				if(panel_num == 2){
					removeac();
					$('#section2').find('.wrap').addClass('animated fadeIn');
					$('#section2').find('.section-avatar').addClass('animated fadeInDown');
					$('#section2').find('.section-tx').addClass('animated fadeInUp');
				}
				if(panel_num == 3){
					removeac();
					$('#section3').find('.wrap').addClass('animated fadeIn');
					$('#section3').find('.section-avatar').addClass('animated fadeInDown');
					$('#section3').find('.section-tx').addClass('animated fadeInUp');
				}
				if(panel_num == 4){
					removeac();
					$('#section4').find('.wrap').addClass('animated fadeIn');
					$('#section4').find('.section-avatar').addClass('animated fadeInDown');
					$('#section4').find('.section-tx,.section-img,.section-opt1,.section-opt2').addClass('animated fadeInUp');
				}
			}
		}
